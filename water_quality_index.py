...
df = pd.read_csv("water_potability_dataset_v2.csv")
st.write(df.head())
...
st.session_state['logistic_test_accuracy'] = acc_log_test * 100  # Save testing accuracy
...
st.session_state['ann_test_accuracy'] = acc_ann_test * 100
...
compare = pd.DataFrame({'Models' : ['XGBoost Classifier','Logistic Regression','Aritifical Neural network'],
                        'Values' :[st.session_state['xgb_test_accuracy'] ,st.session_state['logistic_test_accuracy'],st.session_state['ann_test_accuracy'] ]})
