...
st.session_state['xgb_model_2'] = xgb
st.session_state['xgb_train_accuracy_2'] = acc_xgb1*100 # Save training accuracy
st.session_state['xgb_test_accuracy_2'] = acc_xgb2*100  # Save testing accuracy
...
st.session_state['logistic_test_accuracy_2'] = acc_log_test * 100  # Save testing accuracy
...
st.session_state['ann_test_accuracy_2'] = acc_ann_test * 100
...
compare = pd.DataFrame({'Models' : ['XGBoost Classifier','Logistic Regression','Aritifical Neural network'],
                        'Values' :[st.session_state['xgb_test_accuracy_2'] ,st.session_state['logistic_test_accuracy_2'],st.session_state['ann_test_accuracy_2'] ]})
